...
if($_GET['export'] == 'true'){
$query = mysqli_query($koneksi, "SELECT * from pengguna WHERE status_delete='0' AND status_daftar='2'AND status_pengguna='3' "); // Get data from Database from demo table
