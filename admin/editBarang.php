...
<form method="post" action="barang/update.php">
        <section class="panel">
            ...
            <div class="form-group mt-lg">
				...
				<div class="col-sm-9">
					<input type="text" name="idbarang" required class="form-control" value = "<?php echo $data['id_barang'] ?>" readonly>
				</div>
			</div>
			<div class="form-group mt-lg">
				<label class="col-sm-3 control-label">Nama Barang<span class="required">*</span></label>
				<div class="col-sm-9">
					<input type="text" name="namabarang"  id="namabarang" class="form-control" placeholder="ketik nama barang" value = "<?php echo $data['nama_barang'] ?>" required >
				</div>
			</div>
			<div class="form-group mt-lg">
				...
				<div class="col-sm-9">
					...
					<input type="radio" name="jenisbarang" value="3"<?php if($data['id_jenisBarang']=="3"){echo "checked";} ?>  >Lain-Lain
				</div>
			</div>
