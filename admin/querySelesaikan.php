...
$datapinjaman = mysqli_fetch_array($pinjaman);
    ...
    $msg="Peminjaman Anda dengan kode $idpinjam dan nama acara $pinjam2_acara telah selesai. Terima kasih telah menggunakan Click&Rent SISTech untuk memesan ruangan!";  
