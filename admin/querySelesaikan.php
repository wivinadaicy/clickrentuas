...
$query = mysqli_query($koneksi, "UPDATE peminjaman SET status_peminjaman='3', user_edit='$id', waktu_edit=now() WHERE id_peminjaman='$idpinjam'");
...
"INSERT INTO log_peminjaman values ('$jadibarislogpj2','$idpinjam','$pinjam2_tanggal','$pinjam2_ruang','$pinjam2_mulai','$pinjam2_selesai','$pinjam2_orang','$pinjam2_acara','$pinjam2_peserta','$pinjam2_kategoriacara','$pinjam2_deskripsiacara','3','$id',now())");
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #266e9c; padding-top: 5px;" class="padding-copy">Your reservation with code  '.$idpinjam.' and event name'.$pinjam2_acara.' is done.
                                            <br>
    ...
    header('location:peminjamanAdminLab.php');
?>