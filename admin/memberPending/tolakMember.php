...
$mail->Subject = 'Registration Dennied';
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #266e9c; padding-top: 5px;" class="padding-copy">
                                             Sorry, your reservation is dennied.<br>
                                             This might happend because the data you entered is incorrect or you are not part of the SISTech student / lecturer.<br>
                                             If you feel this is a mistake, please contact us: </td>
                                             
                                             <td align="center" style="border-radius: 3px;" bgcolor="#256F9C"><a href="http://tiny.cc/65k54y" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 15px 25px; border: 1px solid #256F9C; display: inline-block;" class="mobile-button">Contact Us</a></td>
