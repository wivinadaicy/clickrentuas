<div id="modal<?php echo $data['id_mahasiswa'];?>" class="modal-block modal-block-primary mfp-hide">
    <section class="panel">
        <form class="form-horizontal mb-lg" method="post">
        <header class="panel-heading">
            <h2 class="panel-title">Edit Data Mahasiswa</h2>
        </header>
        <div class="panel-body">
            ...
            <div class="form-group mt-lg">
				...
				<div class="col-sm-9">
					<input type="text" name="idprodi"  class="form-control" value = "<?php echo $data['id_programStudi']?>" placeholder="ketik judul buku" required>
				</div>
			</div>
			<div class="form-group mt-lg">
				<label class="col-sm-3 control-label">Angkatan <span class="required">*</span></label>
				<div class="col-sm-9">
					<input type="text" name="angkatan"  class="form-control" value = "<?php echo $data['angkatan']?>" placeholder="ketik judul buku" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">Semester <span class="required">*</span></label>
				<div class="col-sm-9">
					<input type="text" name="semester"  class="form-control" value = "<?php echo $data['semester']?>" placeholder="ketik judul buku" required>
				</div>
			</div>
            <div class="form-group">
				<label class="col-sm-3 control-label">Total SKS <span class="required">*</span></label>
				<div class="col-sm-9">
					<input type="text" name="totalsks"  class="form-control" value = "<?php echo $data['total_sks']?>" placeholder="ketik judul buku" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">IPK <span class="required">*</span></label>
				<div class="col-sm-9">
					<input type="text" name="ipk"  class="form-control" value = "<?php echo $data['ipk_terakhir']?>" placeholder="ketik judul buku" required>
				</div>
			</div>
            </div>
