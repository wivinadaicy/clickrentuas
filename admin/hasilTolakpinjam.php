...
<body  class="site-hero" style="background-image: url(../images/thx-bg.jpg);overflow-x:hidden; overflow-y:hidden; "data-stellar-background-ratio="0.5">
    ...
    <h1 style="padding-top:100px; text-align:center; font-size: 50px;">Reservation sucessfully rejected!</h1>
    
    <p style="padding-bottom: 10px;" align="center"><img src="../images/tolak.png" width="200"></p>
