		...
		<header class="page-header">
			...
			<div class="right-wrapper pull-right">
				<ol class="breadcrumbs">
                    ...
                    <li><span>Lab Reservation</span></li>
				</ol>
...
<section class="panel">
    <header class="panel-heading">
        <h2 class="panel-title">Reservation Lab - Next Booking</h2>
    </header>
		...
		<div class="panel-body">
			<div class="modal-wrapper">
				<div class="modal-text">
					<p>Are you sure that you will finish the reservation with "<?php echo $data['acara']?>" and reservation code: <?php echo $data['id_peminjaman'] ?> ?</p>
				</div>
			</div>
		</div>
...
<section class="panel">
    <header class="panel-heading">
        <h2 class="panel-title">Reservation - Passed</h2>
    </header>
    <div class="panel-body">
        <div class="table-responsive">
            <table class="table table-hover mb-none">
