		...
		<header class="page-header">
			...
			<div class="right-wrapper pull-right">
				<ol class="breadcrumbs">
                    ...
                    <li><a href="logPeminjaman.php"><span>Reservation Log</span></a></li>
...
<section class="panel">
    ...
    <h5><b> User Input:</b> <?php echo $riw['nama_lengkap'] . " (" .$riw['id_pengguna'] . ")" ?></h5>
    <?php
    ?>
        ...
        <table class="table table-striped table-no-more table-bordered  mb-none">
									<thead>
										<tr>
                                            ...
                                            <th style="width: 15%"><span class="text-normal text-sm">Room</span></th>
