...
$query = mysqli_query($koneksi, "SELECT * FROM peminjaman join ruangan on ruangan.id_ruangan=peminjaman.id_ruangan WHERE (status_peminjaman = '1' or status_peminjaman='3') AND id_pengguna='$id' AND peminjaman.id_peminjaman not in (select peminjaman.id_peminjaman from peminjaman where status_peminjaman='0' OR status_peminjaman='4' OR status_peminjaman='5' OR status_peminjaman='6') group by peminjaman.id_ruangan");
